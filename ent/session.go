...
func (*Session) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case session.FieldToken, session.FieldDeviceID, session.FieldDeviceName, session.FieldAppName, session.FieldAppVersion:
			values[i] = new(sql.NullString)
		case session.FieldLastActivity, session.FieldCreatedAt:
